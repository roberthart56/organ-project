...
#scan_pedal_upper_cp.py
#scan upper 22 pedal notes, add changes from lower
#notes received via UART and send USB MIDI command.
...
test = digitalio.DigitalInOut(board.GP28)  
